...
class TestFileStorageDocs(unittest.TestCase):
    ...
    def test_file_storage_module_docstring(self):
        ...
        self.assertIsNot(FileStorage.__module__, None,
                         "file_storage.py needs a docstring")
        self.assertTrue(len(FileStorage.__module__) >= 1,
                        "file_storage.py needs a docstring")
...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        storage = FileStorage()
        dic = {"name": "TestState"}
        instance = BaseModel(**dic)
        instance.id = str(uuid4())
        storage.new(instance)
        storage.save()
        storage = FileStorage()
        get_instance = storage.get(BaseModel, instance.id)
